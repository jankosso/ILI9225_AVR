 ...
 */ 
 ...
 void _writeCommand(uint8_t HI, uint8_t LO){
	 ILI9225_RS_LOW();
	 ILI9225_CS_LOW();
	 ILI9225_WRITE_BYTE(HI);
	 ILI9225_WRITE_BYTE(LO);
	 ILI9225_CS_HIGH();
 }
...
void ILI9225_drawBitmap_P(int16_t x, int16_t y,
...
void ILI9225_drawBitmap(int16_t x, int16_t y,
...
void ILI9225_drawXBitmap(int16_t x, int16_t y,
