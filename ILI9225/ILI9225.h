...
// Hardware
#define ILI9225_RS_DDR	DDRB
#define ILI9225_RS_PORT	PORTB
#define ILI9225_RS_BIT	PORTB1

#define ILI9225_CS_DDR	DDRB
#define ILI9225_CS_PORT	PORTB
#define ILI9225_CS_BIT	PORTB2

#define ILI9225_LED_DDR		DDRD
#define ILI9225_LED_PORT	PORTD
#define ILI9225_LED_BIT		PORTD3


//SPI Interface: Use Hardware SPI Pins!!
#define ILI9225_CLK_DDR		DDRB
#define ILI9225_CLK_PORT	PORTB
#define ILI9225_CLK_BIT		PORTB5
#define ILI9225_SDI_DDR		DDRB
#define ILI9225_SDI_PORT	PORTB
#define ILI9225_SDI_BIT		PORTB3
...
#define RGB565(red8,green8,blue8) ((red8 >> 3) << 11 | (green8 >> 2) << 5 | (blue8 >> 3))
...
#define ILI9225_LED_ON()	do {ILI9225_LED_PORT |= _BV(ILI9225_LED_BIT);} while (0)
#define ILI9225_LED_OFF()	do {ILI9225_LED_PORT &=~_BV(ILI9225_LED_BIT);} while (0)
...
struct _currentFont
{
 ...
 void ILI9225_setBacklight(uint8_t flag);
